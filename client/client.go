...
// Package client provides bindings to the Prometheus API.
package client
...
// // SeriesAPI allows querying Prometheus's series API.
// type SeriesAPI interface {
// 	List(context.Context, ...model.LabelMatchers) ([]model.Metric, error)
// 	Delete(context.Context, ...model.LabelMatchers) (int, error)
// }

// // NewSeriesAPI returns a new SeriesAPI for the client.
// func NewSeriesAPI(c client) SeriesAPI {
// 	return &httpSeriesAPI{c: apiClient{c}}
// }
...
// func (h *httpSeriesAPI) List(context.Context, ...model.LabelMatchers) ([]model.Metric, error) {

// }

// func (h *httpSeriesAPI) Delete(context.Context, ...model.LabelMatchers) (int, error) {

// }

// // LabelsAPI provides bindings to Prometheus labels API.
// type LabelsAPI interface {
// 	Values(ctx context.Context, name string) (model.LabelValues, error)
// }

// // NewLabelsAPI returns a new LabelsAPI for the client.
// func NewLabelsAPI(c Client) LabelsAPI {
// 	return &httpLabelsAPI{c: apiClient{c}}
// }

// type httpLabelsAPI struct {
// 	client Client
// }

// func (h *httpLabelsAPI) Values(ctx context.Context, name string) (model.LabelValues, error) {
